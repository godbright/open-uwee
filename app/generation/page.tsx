  ...
  const checkSandboxStatus = async () => {
    try {
      ...
      if (data.active && data.healthy && data.sandboxData) {
        ...
        // Sandbox exists but not responding - needs recreation
        console.log(
          "[checkSandboxStatus] Sandbox not responding, may need recreation"
        );
        updateStatus("Sandbox stopped - may need recreation", false);
                      ...
                      <div className="block">
                        ...
                        >
                          {msg.type === "command" ? (
                            ...
                            <span className="text-body-input">
                              {msg.content}
                            </span>
                          )}
                        </div>
